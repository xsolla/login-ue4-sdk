	...
	: Super(ObjectInitializer)
{
	...
	static ConstructorHelpers::FClassFinder<UXsollaUtilsWidgetsLibrary> WidgetsLibraryFinder(TEXT("/XsollaLogin/Utils/BP_DefaultWidgetsLibrary.BP_DefaultWidgetsLibrary_C"));
